            ...
            <div id="signup-form-container">
                ...
                <Form>
                    ...
                    <FormGroup>
                        ...
                        <Input type="email" name="email" id="Email" placeholder="Valid e-mail address" onChange={event => setEmail(event.target.value)} />
                    </FormGroup>
                    <FormGroup>
                    ...
                    <FormGroup>
                        ...
                        <Input type="tel" name="phone" id="Phone" placeholder="Phone Number" onChange={event => setPhone(event.target.value)} />
                    </FormGroup>
                    <Button color="primary" block onClick={() => signUp(userName, password, email, phoneNumber)}>Sign Up</Button>
                </Form>
            </div>
        </Col>
    </Row>
